    ...
    return(
        <div style={{ width: "100%", height: 500 }}>
            <Box>
                ...
                <CSVLink filename={"Categoria de Publicação.csv"} data={categoryChartData}>
            ...
            <ResponsiveContainer>
                ...
                >
                    ...
                    <YAxis dataKey="categoria" yAxisId={0}
                    type="category"
                    axisLine={false}
                    tickLine={false}
                    />
                    <Tooltip />
                    <Legend />
                    <Bar name="Fora de Escopo" dataKey="foraEscopo"  stackId="a" fill={colors.greenAccent[300]} />
